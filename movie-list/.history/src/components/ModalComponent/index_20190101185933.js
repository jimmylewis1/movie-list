...
import {
  modalContentWrapper, closeModalBtn, modalTopWrapper,
  modalInstruction, modalPhoneInfo, modalH2, modalWrapper
} from './modal.styles';
  ...
  render() {
    return (
      <div className={modalWrapper}>
        <button className={actionButton} onClick={this.openModal}>Description</button>
        <Modal
